...
u8 xdata cnt=0,num=0,rtc_buf[2],rtc_tmp[2],rtc_ctrl[2];
...
void main()
{
	u8 xdata key,key_buf=0,MenuIndex=0,SettingIndex=0,dig[4];
...
//		_nop_();
		...
		if(MenuIndex==1)  // 时间设置
		{
			...
			TM1650_write_data(0x68, (((SettingIndex == 0) && (cnt>50))?0x00:matrix[dig[0]]));
			TM1650_write_data(0x6A, (((SettingIndex == 1) && (cnt>50))?0x00:matrix[dig[1]]));
			TM1650_write_data(0x6C, (((SettingIndex == 2) && (cnt>50))?0x00:matrix[dig[2]]));
			TM1650_write_data(0x6E, (((SettingIndex == 3) && (cnt>50))?0x00:matrix[dig[3]]));
